...
export class SuiPictureChanger extends SuiElement {
  ...
  _refreshProfileImageTagsAndHideDialog() {
    ...
    document.querySelectorAll(`.sui-user-photo[data-user-id='${getUserId()}']`).forEach(up => {
                ...
                <div id="image-editor-crop-wrapper">
                  <div id="cropme">
                    ...
                    <div id="image-editor-controls-wrapper">
                      <div id="controls">
                        <sui-button @click=${this._zoomIn} type="small" title="${this.i18n.zoom_in}" arial-label="${this.i18n.zoom_in}">
                          <sui-icon type="add"></sui-icon>
                        </sui-button>
                        <sui-button @click=${this._zoomOut} type="small" title="${this.i18n.zoom_out}" arial-label="${this.i18n.zoom_out}">
                          <sui-icon type="minus"></sui-icon>
                        </sui-button>
                        <sui-button @click=${this._up} type="small" title="${this.i18n.pan_up}" arial-label="${this.i18n.pan_up}">
                          <sui-icon type="up"></sui-icon>
                        </sui-button>
                        <sui-button @click=${this._down} type="small" title="${this.i18n.pan_down}" arial-label="${this.i18n.pan_down}">
                          <sui-icon type="down"></sui-icon>
                        </sui-button>
                        <sui-button @click=${this._left} type="small" title="${this.i18n.pan_left}" arial-label="${this.i18n.pan_left}">
                          <sui-icon type="left"></sui-icon>
                        </sui-button>
                        <sui-button @click=${this._right} type="small" title="${this.i18n.pan_right}" arial-label="${this.i18n.pan_right}">
                          <sui-icon type="right"></sui-icon>
                        </sui-button>
                        <sui-button @click=${this._rotate} type="small" title="${this.i18n.rotate}" arial-label="${this.i18n.rotate}">
                          <sui-icon type="refresh"></sui-icon>
                        </sui-button>
                      </div>
                    </div>
                  </div>
