...
export class SuiCourseDashboardTemplatePicker extends SuiDialogContent {
  ...
  buttons() {
    ...
    return html`
      <sui-button @click=${this.select} primary>${this.i18n.select}</sui-button>
    `;
  }
