...
import "@sakai-ui/sui-pronunciation-player";

/**
 * Renders a user's Sakai profile.
 *
 * Usage: <sui-profile user-id="SOMEUSERID"></sui-profile>
 */
export class SuiProfile extends LitElement {
      ...
      <div class="container">
        ...
        <div class="body">
          ...
          <div class="field pronunciation">
            ...
            <sui-pronunciation-player user-id="${this.userId}"></sui-pronunciation-player>
            ` : ""}
          </div>
          ` : ""}
