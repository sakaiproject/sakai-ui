import "../sui-submission-messager.js";
import { html } from "lit";
import * as data from "./data.js";
import { expect, fixture, waitUntil } from "@open-wc/testing";

describe("sui-submission-messager tests", () => {
  ...
  it ("renders correctly", async () => {
    ...
    let el = await fixture(html`
      <sui-submission-messager assignment-id="${data.assignmentId}" title="${data.title}"></sui-submission-messager>
    `);
    ...
    const groupPicker = el.querySelector(`sui-group-picker[site-id='${data.siteId}']`);
