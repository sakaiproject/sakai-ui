...
no_evaluation_404_warning=Since there is no rubrics evaluation for {} you will see a \
404 error from the browser, probably above this warning. Please ignore this, a 404 is expected \
from the server when no evaluation has been made
...
export const rubricsUrl = `/api/sites/${siteId}/rubrics`;
export const rubrics = [ rubric1 ];
