...
export class SuiRubricGradingComment extends RubricsElement {
  ...
  render() {
    ...
    return html`
      <!-- edit icon -->
      <div tabindex="0" style="cursor: pointer;" class="comment-icon fa fa-2x fa-comments ${this.criterion.comments ? "active" : ""}" @click=${this.toggleEditor} @keypress=${this.toggleEditor} title="${this.i18n.criterion_comment}"></div>
      ...
      <div id="criterion-editor-${this.criterion.id}-${this.randombit}" class="popover criterion-edit-popover left">
        ...
        <div class="popover-content form">
          <div class="form-group">
            <textarea
              aria-label="${this.i18n.criterion_comment}"
              class="form-control"
