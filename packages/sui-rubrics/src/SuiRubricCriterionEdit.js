...
export class SuiRubricCriterionEdit extends RubricsElement {
  ...
  render() {
    ...
    return html`
      <a tabindex="0" role="button" class="linkStyle edit fa fa-edit" @focus="${this.onFocus}" @keyup="${this.openEditWithKeyboard}" @click="${this.editCriterion}" title="${this.i18n.edit_criterion} ${this.criterion.title}" aria-label="${this.i18n.edit_criterion} ${this.criterion.title}" href="#"></a>
  ...
  cancelEdit(e) {
    ...
    this.querySelector("sui-editor").setContent(this.criterion.description);
    popover.hide();
  }
