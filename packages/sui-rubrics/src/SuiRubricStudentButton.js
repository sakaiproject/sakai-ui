...
export class SuiRubricStudentButton extends RubricsElement {
  ...
  render() {
    ...
    return html`
      <a @click=${this.showRubric} href="javascript:;" title="${this.i18n.preview_rubric}"><span class="si si-sakai-rubrics"></span></a>
    `;
  }
