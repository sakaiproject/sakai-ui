...
export class SuiRubricAssociation extends RubricsElement {
  ...
  shouldUpdate() {
    return super.shouldUpdate() && this.rubrics && this.rubrics.length > 0;
  }
      ...
      <div class="sakai-rubric-association form">
        ...
        <div class="rubrics-list">
          ...
          <div class="rubrics-selections">
            <select @change="${this._rubricSelected}" name="rbcs-rubricslist" aria-label="${this.i18n.rubric_selector_label}" class="form-control" ?disabled=${!this.isAssociated || this.readOnly}>
