...
import { getUserLocale } from "@sakai-ui/sui-portal-utils";

export class RubricsElement extends SuiElement {
  ...
  isUtilsAvailable() {
    ...
    if (!available) {
      console.error("Rubrics Utils has not been loaded (sui-rubrics-utils.js). THINGS WILL BREAK!");
    }
    return available;
  }
  ...
  makeASummary(type, siteId) {
    ...
    const summary = document.createElement("sui-rubric-summary");
