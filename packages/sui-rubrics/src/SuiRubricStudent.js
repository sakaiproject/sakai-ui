...
import "../sui-rubric-criterion-preview.js";
import "../sui-rubric-criterion-student.js";
import "../sui-rubric-pdf.js";

export class SuiRubricStudent extends RubricsElement {
  ...
  handleClose() {
    ...
    const el = this.querySelector("sui-rubric-criterion-student");
    el && el.handleClose();
  }
