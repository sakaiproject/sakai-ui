...
import "../sui-rubrics-list.js";
import "../sui-rubrics-shared-list.js";

export class SuiRubricsManager extends RubricsElement {
    ...
    return html`
      ...
      <div role="tablist">
        ...
        <div role="tabpanel" aria-labelledby="site-rubrics-title" id="site_rubrics">
          ...
          <br>
          <sui-rubrics-list id="sakai-rubrics"
              site-id="${this.siteId}"
        ...
        <div role="tabpanel" aria-labelledby="shared-rubrics-title" id="shared_rubrics" style="display:none;">
          ...
          <br>
          <sui-rubrics-shared-list id="sui-rubrics-shared-list"
              site-id="${this.siteId}"
              @copy-share-site="${this.copyShareSite}"
              ?enable-pdf-export=${this.enablePdfExport}>
          </sui-rubrics-shared-list>
        </div>
        <br>
        </div>
      </div>
  ...
  handleSharingChange() {
    document.getElementById("sui-rubrics-shared-list").refresh();
  }

  copyShareSite() {
    this.querySelector("sui-rubrics-list").refresh();
  }
  ...
  filterRubrics() {
    ...
    this.querySelectorAll("sui-rubrics-list, sui-rubrics-shared-list").forEach(rubricList => {
  ...
  sortRubrics(event) {
    ...
    const list = this.querySelector(rubricClass === "site" ? "sui-rubrics-list" : "sui-rubrics-shared-list");
