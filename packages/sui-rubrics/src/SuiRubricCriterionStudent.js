...
import "../sui-rubric-student-comment.js";

export class SuiRubricCriterionStudent extends RubricsElement {
  ...
  handleClose() {
    ...
    this.querySelectorAll("sui-rubric-student-comment").forEach(el => el.handleClose());
  }
        ...
        ${this.criteria.map(c => html`
          ...
          ` : html`
            <div id="criterion_row_${c.id}" class="criterion-row">
              ...
              ${!this.preview ? html`
                <sui-rubric-student-comment criterion="${JSON.stringify(c)}"></sui-rubric-student-comment>
