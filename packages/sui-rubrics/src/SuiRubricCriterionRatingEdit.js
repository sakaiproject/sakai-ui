...
export class SuiRubricCriterionRatingEdit extends RubricsElement {
  ...
  render() {
    ...
    return html`
      <a tabindex="0" role="button" class="linkStyle edit fa fa-edit" @focus="${this.onFocus}" @keyup="${this.openEditWithKeyboard}" @click="${this.editRating}" title="${this.i18n.edit_rating} ${this.rating.title}" aria-label="${this.i18n.edit_rating} ${this.rating.title}" href="#"></a>
      ...
      <div id="edit_criterion_rating_${this.rating.id}" class="popover rating-edit-popover bottom rubrics-popover">
        ...
        <div class="popover-title">
          <div class="buttons act">
            <button class="active btn-xs save" title="${this.i18n.save} ${this.rating.title}" @click="${this.saveEdit}">
              <sr-lang key="save">Save</sr-lang>
            </button>
            ${!this.isLocked ? html`
              <button class="btn-link delete" title="${this.removeButtonTitle()}" ?disabled="${!this.removable}" @click="${this.deleteRating}"><sr-lang key="remove_label"></sr-lang></button>
            ` : ""}
            <button class="btn btn-link btn-xs cancel" title="${this.i18n.cancel}" @click="${this.cancelEdit}">
        ...
        <div class="popover-content form">
          <div class="first-row">
              <div class="form-group title">
                <label class="label-rubrics" for="rating-title-${this.rating.id}"><sr-lang key="rating_title"></sr-lang></label>
              ...
              <div class="form-group points ${this.isLocked ? "d-none" : ""}">
                <label class="label-rubrics" for="rating-points-${this.rating.id}"><sr-lang key="points"></sr-lang></label>
          ...
          <div class="form-group">
            <label class="label-rubrics" for="rating-description-${this.rating.id}"><sr-lang key="rating_description"></sr-lang></label>
  ...
  removeButtonTitle() {
    if (this.removable) {
      return `${this.i18n.remove_label} ${this.rating.title}`;
    }
    return this.i18n.remove_rating_disabled;
  }
}
