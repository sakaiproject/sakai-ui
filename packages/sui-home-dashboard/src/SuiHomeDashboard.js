...
import "@sakai-ui/sui-course-list";
import "@sakai-ui/sui-widget-panel";
import "@sakai-ui/sui-button";

export class SuiHomeDashboard extends LitElement {

  constructor() {

    super();
    loadProperties("dashboard").then(r => { this.i18n = r; this.requestUpdate(); });
  }
