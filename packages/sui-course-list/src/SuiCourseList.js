...
import "@sakai-ui/sui-course-card";
import { loadProperties } from "@sakai-ui/sui-i18n";

export class SuiCourseList extends LitElement {
  ...
  render() {
    ...
    return html`
      <div id="course-list-controls">
        ...
        <div id="term-filter">
          <select aria-label="Term filter" @change=${this.termSelected} .value=${this.currentTermFilter}>
