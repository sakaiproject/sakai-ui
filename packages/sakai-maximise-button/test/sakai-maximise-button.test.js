import "../sakai-maximise-button.js";
import { expect, fixture, waitUntil } from "@open-wc/testing";
import { html } from "lit";
import * as data from "./data.js";

describe("sakai-maximise-button tests", () => {
  ...
  it ("renders correctly", async () => {
    ...
    let el = await fixture(html`<sakai-maximise-button></sakai-maximise-button>`);
    ...
    el = await fixture(html`<sakai-maximise-button full-screen></sakai-maximise-button>`);
    await waitUntil(() => el.i18n);
    expect(el.querySelector(`a[title='${el.i18n.normal_view}']`)).to.exist;
    el.setMinimised();
    await el.updateComplete;
    ...
    el = await fixture(html`<sakai-maximise-button></sakai-maximise-button>`);
  ...
  it ("is accessible", async () => {
    ...
    const el = await fixture(html`<sakai-maximise-button></sakai-maximise-button>`);
    await waitUntil(() => el.i18n);
