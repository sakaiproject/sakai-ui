...
import "../sui-grader-file-picker.js";
import "@sakai-ui/sui-date-picker";
import "@sakai-ui/sui-group-picker";
import "@sakai-ui/sui-document-viewer";
import "@sakai-ui/sui-lti-iframe";
import "@sakai-ui/sui-user-photo";
import { gradableDataMixin } from "./sui-gradable-data-mixin.js";
import { Submission } from "./submission.js";
//import "@sakai-ui/sui-rubrics/rubric-association-requirements.js";
//import "@sakai-ui/sui-rubrics/sui-rubric-grading-button.js";

import { GRADE_CHECKED,
          LETTER_GRADE_TYPE,
          SCORE_GRADE_TYPE,
          PASS_FAIL_GRADE_TYPE,
          CHECK_GRADE_TYPE } from "./sui-grader-constants.js";

export class SuiGrader extends gradableDataMixin(SuiElement) {
              ...
              <div class="modal-body">
                ...
                ${this.isGroupGradable ? "" : html`
                  <div class="grader-groups">
                    ...
                    <sui-group-picker groups="${JSON.stringify(this.groups)}" @group-selected=${this.groupSelected}></sui-group-picker>
                  </div>
                `}
              </div>
