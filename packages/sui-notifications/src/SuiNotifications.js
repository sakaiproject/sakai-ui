...
export class SuiNotifications extends SuiElement {
  ...
  constructor() {
    ...
    this.i18nLoaded = this.loadTranslations("sui-notifications");
    this.i18nLoaded.then(i18n => { this.i18n = i18n; this.requestUpdate(); });
  }
  ...
  async filterIntoToolNotifications() {
