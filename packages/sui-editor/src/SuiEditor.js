...
export class SuiEditor extends SuiElement {
  ...
  attachEditor() {
    ...
    if (sakai?.editor?.launch) {
      ...
      this.editor = CKEDITOR.replace(this.elementId, { toolbar: SuiEditor.toolbars.get("basic") });
    }
...
SuiEditor.toolbars = new Map();
SuiEditor.toolbars.set("basic", [ { name: "document", items : [ "Source", "-", "Bold", "Italic", "Underline", "-", "Link", "Unlink", "-", "NumberedList", "BulletedList", "Blockquote" ] } ]);
