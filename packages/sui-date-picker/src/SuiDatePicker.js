 ...
 * <sui-date-picker epoch-millis="345922925445"></sui-date-picker>
 *
  ...
  render() {
    ...
    return html`
      ...
      ${this.addHiddenFields && this.isoDate ? html`
        ${SuiDatePicker.hiddenFieldNames.map(h => html`
...
SuiDatePicker.hiddenFieldNames = [ "year", "month", "day", "hour", "min" ];
